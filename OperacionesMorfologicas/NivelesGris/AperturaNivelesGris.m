...
b=aplicarApertura(objEstruc,tamObj,a);
figure;
imshow(b);

function imgResult=aplicarApertura(objEstruc,tamOb,img)
    i=aplicarErosion(objEstruc,tamOb,img);    
    imgResult=aplicarDilatacion(objEstruc,tamOb,i);
end
